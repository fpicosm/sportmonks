...
class PredictionsTest extends TestCase
{
    ...
    {
        $response = Sportmonks::football()->predictions()->all();
    ...
    {
        $leagueId = 8;
        $response = Sportmonks::football()->predictions()->byLeague($leagueId);
    ...
    {
        $fixtureId = 16774022;
        $response = Sportmonks::football()->predictions()->byFixture($fixtureId);
    ...
    {
        $response = Sportmonks::football()->predictions()->valueBets();
    ...
    {
        $fixtureId = 18535050;
        $response = Sportmonks::football()->predictions()->valueBetsByFixture($fixtureId);
