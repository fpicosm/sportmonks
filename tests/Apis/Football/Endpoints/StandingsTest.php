...
class StandingsTest extends TestCase
{
    ...
    {
        $response = Sportmonks::football()->standings()->all();
    ...
    {
        $seasonId = 23621;
        $response = Sportmonks::football()->standings()->bySeason($seasonId);
    ...
    {
        $seasonId = 23621;
        $response = Sportmonks::football()->standings()->correctionBySeason($seasonId);
    ...
    {
        $roundId = 339303;
        $response = Sportmonks::football()->standings()->byRound($roundId);
    ...
    {
        $leagueId = 8;
        $response = Sportmonks::football()->standings()->liveByLeague($leagueId);
