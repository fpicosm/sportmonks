...
class SchedulesTest extends TestCase
{
    ...
    {
        $seasonId = 23621;
        $response = Sportmonks::football()->schedules()->bySeason($seasonId);
    ...
    {
        $teamId = 83;
        $response = Sportmonks::football()->schedules()->byTeam($teamId);
    ...
    #[Test] public function get_schedules_by_season_id_and_team_id_test()
    {
        $seasonId = 23621;
        $teamId = 83;
        $response = Sportmonks::football()->schedules()->bySeasonAndTeam($seasonId, $teamId);
