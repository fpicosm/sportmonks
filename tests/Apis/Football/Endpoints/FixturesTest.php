...
class FixturesTest extends TestCase
{
    ...
    {
        $response = Sportmonks::football()->fixtures()->all();
    ...
    {
        $fixtureId = 463;
        $response = Sportmonks::football()->fixtures()->find($fixtureId);
    ...
    {
        $fixtureIds = [463, 464];
        $response = Sportmonks::football()->fixtures()->multiple($fixtureIds);
        ...
        $response = Sportmonks::football()->fixtures()->multiple('463,464');
        ...
        Sportmonks::football()->fixtures()->multiple('463,463');
    }
    ...
    #[Test] public function get_fixtures_by_date_test(): void
    {
        ...
        $response = Sportmonks::football()->fixtures()->byDate($date);
        ...
        $response = Sportmonks::football()->fixtures()->byDate(Carbon::make($date));
        $this->assertEquals("/v3/football/fixtures/date/$date", $response->url->getPath());
        $this->assertEquals(200, $response->statusCode);
    }
    ...
    #[Test] public function get_fixtures_by_date_range_test(): void
    {
        ...
        $response = Sportmonks::football()->fixtures()->byDateRange($from, $to);
        ...
        $response = Sportmonks::football()->fixtures()->byDateRange(Carbon::make($from), $to);
        $this->assertEquals("/v3/football/fixtures/between/$from/$to", $response->url->getPath());
        $this->assertEquals(200, $response->statusCode);
    }
    ...
    #[Test] public function get_fixtures_by_date_range_for_team_test(): void
    {
        ...
        $response = Sportmonks::football()->fixtures()->byDateRangeForTeam($from, $to, $teamId);
        ...
        $response = Sportmonks::football()->fixtures()->byDateRangeForTeam(Carbon::make($from), $to, $teamId);
        $this->assertEquals("/v3/football/fixtures/between/$from/$to/$teamId", $response->url->getPath());
        $this->assertEquals(200, $response->statusCode);
    }
    ...
    #[Test] public function get_fixtures_by_head_to_head_test(): void
    {
        ...
        $response = Sportmonks::football()->fixtures()->h2h($teamId, $rivalId);
    ...
    {
        $name = 'manches';
        $response = Sportmonks::football()->fixtures()->search($name);
    ...
    {
        $marketId = 1;
        $response = Sportmonks::football()->fixtures()->upcomingByMarket($marketId);
    ...
    {
        $tvStationId = 1;
        $response = Sportmonks::football()->fixtures()->upcomingByTvStation($tvStationId);
    ...
    {
        $tvStationId = 1;
        $response = Sportmonks::football()->fixtures()->pastByTvStation($tvStationId);
    ...
    {
        $response = Sportmonks::football()->fixtures()->lastUpdated();
