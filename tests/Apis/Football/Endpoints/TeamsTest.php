...
class TeamsTest extends TestCase
{
    ...
    {
        $response = Sportmonks::football()->teams()->all();
    ...
    {
        $teamId = 83;
        $response = Sportmonks::football()->teams()->find($teamId);
    ...
    {
        $countryId = 32;
        $response = Sportmonks::football()->teams()->byCountry($countryId);
    ...
    {
        $seasonId = 23621;
        $response = Sportmonks::football()->teams()->bySeason($seasonId);
    ...
    {
        $name = 'barcel';
        $response = Sportmonks::football()->teams()->search($name);
        ...
        $this->assertStringNotContainsString($name, $response->data[0]->name);
    }
}
