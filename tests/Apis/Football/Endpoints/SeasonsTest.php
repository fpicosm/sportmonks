...
class SeasonsTest extends TestCase
{
    ...
    {
        $response = Sportmonks::football()->seasons()->all();
    ...
    {
        $seasonId = 23621;
        $response = Sportmonks::football()->seasons()->find($seasonId);
    ...
    {
        $teamId = 83;
        $response = Sportmonks::football()->seasons()->byTeam($teamId);
    ...
    {
        $name = 2022;
        $response = Sportmonks::football()->seasons()->search($name);
