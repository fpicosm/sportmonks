...
class NewsPreMatchTest extends TestCase
{
    ...
    {
        $response = Sportmonks::football()->news()->preMatch()->all();
    ...
    {
        $seasonId = 19734;
        $response = Sportmonks::football()->news()->preMatch()->bySeason($seasonId);
    ...
    {
        $response = Sportmonks::football()->news()->preMatch()->upcoming();
