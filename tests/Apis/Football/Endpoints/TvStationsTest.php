...
class TvStationsTest extends TestCase
{
    ...
    {
        $response = Sportmonks::football()->tvStations()->all();
    ...
    {
        $tvStationId = 1;
        $response = Sportmonks::football()->tvStations()->find($tvStationId);
    ...
    {
        $fixtureId = 1;
        $response = Sportmonks::football()->tvStations()->byFixture($fixtureId);
